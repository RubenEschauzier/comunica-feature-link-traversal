...
import type { IActionInit, IActorOutputInit } from '../../bus-init-topology/lib';
...
export class ActorInitQuery<QueryContext extends IQueryContextCommon = IQueryContextCommon>
  ...
  public async run(action: IActionInit): Promise<IActorOutputInit> {
    ...
    for (const cliArgsHandler of cliArgsHandlers) {
      // Weird casting workaround
      argumentsBuilder = <yargs.Argv<{}>> cliArgsHandler.populateYargs(argumentsBuilder);
    }
