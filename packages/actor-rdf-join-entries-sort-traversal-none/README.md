# Comunica Zero-knowledge-based Traversal RDF Join Entries Sort Actor
...
that does not reorder join entries.
...
```bash
$ yarn add @comunica/actor-rdf-join-entries-sort-traversal-none
```
...
```text
{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/actor-rdf-join-entries-sort-traversal-none/^2.0.0/components/context.jsonld"
  ],
  "actors": [
    ...
    {
      "@id": "urn:comunica:default:rdf-join-entries-sort/actors#traversal-zero-knowledge",
      "@type": "ActorRdfJoinEntriesSortTraversalNone"
    }
  ]
}
```
