...
import { LinkQueueIsRcc1Prioritization } from './LinkQueueIsRcc1Prioritization';

/**
 * A comunica Wrapper Is Rcc1 Prioritization RDF Resolve Hypermedia Links Queue Actor.
 */
export class ActorRdfResolveHypermediaLinksQueueWrapperIsRcc1Prioritization extends ActorRdfResolveHypermediaLinksQueue {
  private readonly mediatorRdfResolveHypermediaLinksQueue: MediatorRdfResolveHypermediaLinksQueue;

  public constructor(args: IActorRdfResolveHypermediaLinksQueueWrapperIsRcc1PrioritizationArgs) {
    super(args);
  }
  ...
  public async run(action: IActionRdfResolveHypermediaLinksQueue): Promise<IActorRdfResolveHypermediaLinksQueueOutput> {
    ...
    return { linkQueue: new LinkQueueIsRcc1Prioritization(linkQueue, topologyStatistic, intermediateResults) };
  }
}
...
export interface IActorRdfResolveHypermediaLinksQueueWrapperIsRcc1PrioritizationArgs
