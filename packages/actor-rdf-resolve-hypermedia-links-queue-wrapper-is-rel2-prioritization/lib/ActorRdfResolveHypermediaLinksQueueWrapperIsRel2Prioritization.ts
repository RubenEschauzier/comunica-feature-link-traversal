...
import { LinkQueueIsRel2Prioritization } from './LinkQueueIsRel2Prioritization';
import { StatisticIntermediateResults } from '@comunica/statistic-intermediate-results';
import { KeysStatistics } from '@comunica/context-entries';

/**
 * A comunica Wrapper Is Rel2 Prioritization RDF Resolve Hypermedia Links Queue Actor.
 */
export class ActorRdfResolveHypermediaLinksQueueWrapperIsRel2Prioritization extends ActorRdfResolveHypermediaLinksQueue {
  private readonly mediatorRdfResolveHypermediaLinksQueue: MediatorRdfResolveHypermediaLinksQueue;

  public constructor(args: IActorRdfResolveHypermediaLinksQueueWrapperIsRel2PrioritizationArgs) {
    super(args);
  }
  ...
  public async run(action: IActionRdfResolveHypermediaLinksQueue): Promise<IActorRdfResolveHypermediaLinksQueueOutput> {
    ...
    return { linkQueue: new LinkQueueIsRel2Prioritization(linkQueue, topologyStatistic, intermediateResults) };
  }
}
...
export interface IActorRdfResolveHypermediaLinksQueueWrapperIsRel2PrioritizationArgs
