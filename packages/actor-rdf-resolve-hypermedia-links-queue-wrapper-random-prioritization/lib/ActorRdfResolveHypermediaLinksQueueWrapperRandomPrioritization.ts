 ...
 */
export class ActorRdfResolveHypermediaLinksQueueWrapperRandomPrioritization extends
  ActorRdfResolveHypermediaLinksQueue {
  private readonly mediatorRdfResolveHypermediaLinksQueue: MediatorRdfResolveHypermediaLinksQueue;

  public constructor(args: IActorRdfResolveHypermediaLinksQueueWrapperRandomPrioritizationArgs) {
    super(args);
  }
...
export interface IActorRdfResolveHypermediaLinksQueueWrapperRandomPrioritizationArgs
