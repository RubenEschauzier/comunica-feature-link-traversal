...
import type { ITraversalIndex } from './TraversalCacheIndex';
import { TraversalCacheIndex } from './TraversalCacheIndex';

export class TraversalCache<K extends string, V extends {}> implements ITraversalCache<K, V> {
  private readonly cache: LRUCache<K, V>;
  private readonly traversalIndex: ITraversalIndex<K>;
  private readonly solidTraversalPredicates: string[];
