...
import type { IActionContext, MetadataBindings, IQuerySource } from '@comunica/types';
import type * as RDF from '@rdfjs/types';
import type { AsyncIterator } from 'asynciterator';

/**
 * An aggregated store allows data lookup and insertion to happen in parallel.
